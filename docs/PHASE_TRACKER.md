...
```
phases_total:    11
phases_done:      8   (F0, F1a, F1b, F2-intro, F2-wt, F3a, F3b, F4a)
phases_pending:   3   (F4b, F5b, F6a — F6a unblocked)
open_prs:         0
prs_merged:       8   (#3 F0, #4 F1a, #5 F1b, #6 F2-intro, #7 F2-wt, #8 F3b, #15 F3a, #16 F4a)
open_issues:      3   (#11 F4b, #12 F5b, #13 F6a)
last_updated:     2026-05-18
post_merge:       main at F4a; tests 476 passed / 113 skipped; invariants 27/27
```
