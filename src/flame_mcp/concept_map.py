...
CONCEPT_MAP: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "recipe": (
            ...
            "'setup batch'): use THIS template verbatim — it passes every "
            "guard on the first submission; fill SHOT and CLIP_PATH only. "
            "Do not inspect selections or existing groups first; create, "
            "then verify with list_batch_groups (it is main-threaded).\n"
            "```\n"
