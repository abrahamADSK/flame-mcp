...
CONCEPT_MAP: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "recipe": (
            ...
            "op 'setup_comp_batch' (args: shot, clip_path, optional "
            "comp_dir) creates '<shot>_comp' with a 'sources' reel, imports "
            "the source clip, and wires it to a Write File whose open-clip "
            "target is the SOURCE's .clip (comp versions land in the "
            "conformed clip, so the timeline flips natively).\n"
            ...
            "repeat) and relay its set/skipped report. FRAME ALIGNMENT is "
