...
CONCEPT_MAP: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "recipe": (
            ...
            "   f) VERIFY THE ANCHOR of every segment of the conformed "
            ...
            "   g) the version FLIP stays MANUAL. Never switch versions for "
            ...
            "   h) report DONE with: the publish ids, the Version id, the "
